# 1 "c:\\Users\\olive\\Documents\\Projekte\\Brunnen\\code\\code.ino"
/**
...
**/
# 22 "c:\\Users\\olive\\Documents\\Projekte\\Brunnen\\code\\code.ino"
//===============================================================================================
// LIBRARIES
//===============================================================================================
# 26 "c:\\Users\\olive\\Documents\\Projekte\\Brunnen\\code\\code.ino" 2
# 27 "c:\\Users\\olive\\Documents\\Projekte\\Brunnen\\code\\code.ino" 2
# 28 "c:\\Users\\olive\\Documents\\Projekte\\Brunnen\\code\\code.ino" 2
# 29 "c:\\Users\\olive\\Documents\\Projekte\\Brunnen\\code\\code.ino" 2
...
portMUX_TYPE timerMux = { .owner = 0xB33FFFFF, .count = 0, }; // mutex semaphore for loopEntry variable
hw_timer_t *loopTimer = 
# 38 "c:\\Users\\olive\\Documents\\Projekte\\Brunnen\\code\\code.ino" 3 4
                       __null
# 38 "c:\\Users\\olive\\Documents\\Projekte\\Brunnen\\code\\code.ino"
                           ;
static void __attribute__((section(".iram1"))) onTimer(){
...
void setup() {
    ...
    timerAlarmWrite(loopTimer, 1000000 /* loop period in us*/, true);
